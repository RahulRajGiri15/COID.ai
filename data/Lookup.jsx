...
export default {
  ...
  HERO_HEADING: "Unleash your imagination. What will you create?",
  HERO_DESC: "Prompt, develop, refine, and bring your full-stack ideas to life",
  INPUT_PLACEHOLDER: "What you want to build?",
  SIGNIN_HEADING: "Continue With NovaCode AI",
  SIGNIN_SUBHEADING:
    "To use NovaCode AI you must log into an existing account or create one.",
  SIGNIn_AGREEMENT_TEXT:
    "By using NovaCode, you agree to the collection of usage data for analytics.",
